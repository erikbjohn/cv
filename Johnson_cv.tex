...
\begin{innerlist}
    ...
    \item[] Culverhouse School of Commerce
...
\item[]Towards a new view of corporate headquarter relocation: the role of professional networks in location choice.
 ...
 \item[] Estimating the role of Emotion in Auctions
 \begin{innerlist}\item[] with Cary Deck and Adrianna Braeban \emph{[Working]}\end{innerlist}
...
(e-mail:~\href{mcmillen@illinois.edu}{mcmillen@illinois.edu}; phone:~+1 217-333-8930)
\begin{innerlist}
   \item[]Professor of Economics, University of Illinois
\end{innerlist}
